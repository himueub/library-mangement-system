...
elseif($msg=="fail"){
    ...
    ?>
        ...
        <div class="innerdiv">
            ...
            <div><label>Branch:</label><input type="radio" name="branch" value="other"/>Other<input type="radio" name="branch" value="BCE"/>BCE<div style="margin-left:80px"><input type="radio" name="branch" value="BCSE"/>BCSE<input type="radio" name="branch" value="BEEE"/>BEEE</div>
            </div>   
